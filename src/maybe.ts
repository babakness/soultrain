import { HKT, URI2HKT, URIS, Type } from 'fp-ts/lib/HKT'
import { adtn, Apply, Applicative, ArrayApplicative, ArrayApply, HKT0,  } from './helper-types'
import { isNullyOrNaN, isNullable } from './check'
// export const isNully = a => a === undefined || a === null || ( typeof a === 'number' && isNaN( a ) )
...
// const fromNullable = <A>(a:A | null | undefined): Maybe<A> => isNullable(a) ? nothing : Just.of(a)
