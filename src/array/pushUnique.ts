...
interface IPushUniqueSecondLayer<Item> {
...
interface IPushUnique {
  ...
  <Item extends BasicTypes>( item: Item ): IPushUniqueSecondLayer<Item>
}
/**
 * Push an item to an array if the item isn't already in array.
 ...
 * //=> [1,2,3,[4]] : [1,2,3,[4]]
 */
export const pushUnique: IPushUnique = ( ...args ) => {
