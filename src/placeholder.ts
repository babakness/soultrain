...
export function placeholder(fn,...placeholders) {
  return _placeholders(fn, ...placeholders)
}


const _papp = untypedCurry((fn,partials) => (args) => fn( ...partials, ...args ))
const _pappRight = untypedCurry((fn,partials) => (args) => fn( ...args, ...partials ))
