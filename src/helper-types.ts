...
export type StrictPartial<O, P> = { [K in keyof P]: K extends keyof O ? O[K] : never }

export type DeepPartialFlexibleType<T> = {
  [P in keyof T]?: T[P] extends Array<infer U>
    ? Array<DeepPartialFlexibleType<U>>
    : T[P] extends ReadonlyArray<infer UU> ? ReadonlyArray<DeepPartialFlexibleType<UU>> : DeepPartialFlexibleType<unknown>
}
